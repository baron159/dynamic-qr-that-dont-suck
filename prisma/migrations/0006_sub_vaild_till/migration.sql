-- AlterTable
ALTER TABLE "User" ADD COLUMN "subscriptionValidTill" DATETIME;
...
INSERT INTO "new_Qr" ("active", "createdAt", "creditId", "id", "kvId", "nickname", "options", "redirectLink", "scanCount", "updatedAt", "userId") SELECT "active", "createdAt", "creditId", "id", "kvId", "nickname", "options", "redirectLink", "scanCount", "updatedAt", "userId" FROM "Qr";
DROP TABLE "Qr";
